...
const CpuArchitecture = ({
  ...
  return (
    <>
      <style>{`
        @keyframes cpu-line-1 {
          0%, 100% { offset-distance: 0%; }
          50% { offset-distance: 100%; }
        }
        @keyframes cpu-line-2 {
          0%, 100% { offset-distance: 0%; }
          50% { offset-distance: 100%; }
        }
        @keyframes cpu-line-3 {
          0%, 100% { offset-distance: 0%; }
          50% { offset-distance: 100%; }
        }
        @keyframes cpu-line-4 {
          0%, 100% { offset-distance: 0%; }
          50% { offset-distance: 100%; }
        }
        @keyframes cpu-line-5 {
          0%, 100% { offset-distance: 0%; }
          50% { offset-distance: 100%; }
        }
        @keyframes cpu-line-6 {
          0%, 100% { offset-distance: 0%; }
          50% { offset-distance: 100%; }
        }
        @keyframes cpu-line-7 {
          0%, 100% { offset-distance: 0%; }
          50% { offset-distance: 100%; }
        }
        @keyframes cpu-line-8 {
          0%, 100% { offset-distance: 0%; }
          50% { offset-distance: 100%; }
        }
        
        .cpu-line-1 {
          offset-path: path("M 5 20 h 89.5 q 5 0 5 5 v 30");
          animation: cpu-line-1 3s ease-in-out infinite;
        }
        .cpu-line-2 {
          offset-path: path("M 195 10 h -89.7 q -5 0 -5 5 v 30");
          animation: cpu-line-2 3s ease-in-out infinite 0.3s;
        }
        .cpu-line-3 {
          offset-path: path("M 140 15 v 26.8 q 0 5 -5 5 h -20");
          animation: cpu-line-3 3s ease-in-out infinite 0.6s;
        }
        .cpu-line-4 {
          offset-path: path("M 180 85 v -31.8 q 0 -5 -5 -5 h -60");
          animation: cpu-line-4 3s ease-in-out infinite 0.9s;
        }
        .cpu-line-5 {
          offset-path: path("M 145 65 h 25 q 5 0 5 5 v 15 q 0 5 -5 5 h -64.8 q -5 0 -5 -5 v -25");
          animation: cpu-line-5 3s ease-in-out infinite 1.2s;
        }
        .cpu-line-6 {
          offset-path: path("M 94.8 100 v -41");
          animation: cpu-line-6 3s ease-in-out infinite 1.5s;
        }
        .cpu-line-7 {
          offset-path: path("M 85 93 v -20 q 0 -5 -5 -5 h -15 q -5 0 -5 -5 v -10 q 0 -5 5 -5 h 22");
          animation: cpu-line-7 3s ease-in-out infinite 1.8s;
        }
        .cpu-line-8 {
          offset-path: path("M 20 30 h 35 q 5 0 5 5 v 11.5 q 0 5 5 5 h 20");
          animation: cpu-line-8 3s ease-in-out infinite 2.1s;
        }
      `}</style>
      <svg
        className={className}
      ...
      >
        ...
        viewBox="0 0 200 100"
      > */}
        {/* Paths - Changed to use a darker color that works in both modes */}
        <g
          stroke="#666666"
          fill="none"
          strokeWidth="0.3"
