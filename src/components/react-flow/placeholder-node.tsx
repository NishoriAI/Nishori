...
export function PlaceholderNode({ children, onClick  }: PlaceholderNodeProps) {
  ...
  return (
    <BaseNode
      className="bg-card w-auto h-auto border-dashed border-gray-400 p-4 cursor-pointer text-center text-gray-400 shadow-none hover:border-gray-500 hover:bg-gray-50"
      onClick={onClick}
    >
      {children}
      <Handle
